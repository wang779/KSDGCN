...
if __name__ == '__main__':
    ...
    # 从train_data_knowledges.raw文件（所有生成的知识）中选择一些知识，每行写到train_selectedKnow_minor.txt'
    train_knowledge_file = p.dataset_path+'/final_knowledges_train.raw'
    train_output_file = p.dataset_path+'/train_selectedKnow_minor.txt'

    test_knowledge_file = p.dataset_path+'/final_knowledges_test.raw'
    test_output_file = p.dataset_path+'/test_selectedKnow_minor.txt'
