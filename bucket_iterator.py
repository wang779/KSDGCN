...
class BucketIterator(object):
    ...
    def pad_data(self, batch_data):
        ...
        for item in batch_data:
            ...
            (0, max_len2 - len(dependency_graph)), (0, max_len2 - len(dependency_graph))), 'constant'))
            batch_sentic_graph.append(
                numpy.pad(sentic_graph, ((0, max_len1 - len(sentic_graph)), (0, max_len1 - len(sentic_graph))),
                          'constant'))
